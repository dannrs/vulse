    ...
    <div className='my-20 flex items-center justify-center '>
      <div className='flex flex-col items-center justify-center gap-5 text-center'>
        ...
        <div className='flex flex-col gap-8'>
          ...
          <div className='flex max-w-5xl flex-row-reverse items-center'>
            <Image src='/hero.png' width={630} height={360} alt='Hero image' />
            <div className='mx-8 flex flex-col items-start space-y-1'>
              <h3 className='text-lg font-semibold text-[#CD44D0]'>
                Personalized
        ...
        <div className='h-64 rounded-xl w-full bg-[#CD44D0] flex flex-col items-center justify-center space-y-2 my-10'>
          <h2 className='text-4xl font-semibold'>Vulse is now in beta</h2>
          <p className='text-foreground/80'>Be the first to access the Vulse beta!</p>
