...
import { CameraIcon, Dot } from 'lucide-react';
          ...
          {profilePicture?.url ? (
            <div className='group relative mx-auto my-4 h-[150px] w-[150px] cursor-pointer'>
              <Image
                ...
                width={150}
                height={150}
                className='aspect-square rounded-full transition-opacity duration-200 group-hover:opacity-80'
                onClick={onImageClick}
              />
              <CameraIcon className='absolute bottom-2 right-0 h-7 w-7 rounded-full bg-primary p-1 text-white transition-colors duration-200 group-hover:bg-primary/90 group-hover:text-white/90' />
              <Input
                type='file'
                accept='image/*'
                className='hidden'
